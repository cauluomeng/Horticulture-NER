...
if __name__ == '__main__':
	train_text = "于是我就给[@朱333333333#Location*]校长、[@张钟俊#Location*]院长给他们写了一个报告!"
	decode_text = "张钟俊院长，给他[$张钟俊#Location*]and[$张钟#Location*]..[@朱物华#Location*]aircraft,weekend."
	print(train_text)
	...
	generateDictFile('plant.txt', train_text)
	DictFilerRank('plant.txt')